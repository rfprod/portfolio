...
export interface IGithubApiEngpoints {
...
export interface IGuthubUser {
  ...
  created_at: string;
  updated_at: string;
  plan: IGuthubUserPlan;
}

export interface IGithubUserRepoOwner {
  login: string;
  id: number;
  node_id: string;
  avatar_url: string;
...
export interface IGithubUserRepoLicense {
  key: string;
  name: string;
  spdx_id: string;
  url: string;
...
export interface IGithubUserRepo {
  ...
  license: IGithubUserRepoLicense;
  forks: number;
  open_issues: number;
  watchers: number;
...
export interface IGithubRepoLanguages {
  [key: string]: number;
}
